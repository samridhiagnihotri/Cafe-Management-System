...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="max-w-6xl mx-auto flex items-center justify-between h-20 p-3 z-50 sticky top-0 bg-transparent">
        <div>
          <Link href={"/"}>
            <a>
        ...
        <div className="text-pink-100 md:text-lg flex items-center font-semibold space-x-5">
          {isMatch ? (
            <>
              <Drawer
                open={openDrawer}
                  ...
                  <Link href={"/"}>
                    <a>
                      ...
                      >
                        ...
                        <h1 className="text-pink-100 font-semibold">Home</h1>
                      </div>
                    </a>
                  </Link>
                  <Link href={"/foods"}>
            ...
            <>
              <Link href={"/"}>
                <a className="cursor-pointer hover:text-pink-500 transition duration-300 ease-in">
                  Home
                </a>
              </Link>
              <Link href={"/foods"}>
          ...
          <Link href={"/cart"}>
            <a className="cursor-pointer hover:text-pink-500 transition duration-300 relative ease-in">
              <ShoppingBasket />
              {cart.length > 0 && (
