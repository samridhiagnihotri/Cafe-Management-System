...
const AdminSidebar = () => {
  return (
    <>
      <div className="w-52 border-2 border-pink-300 h-[101px] fixed left-24">
        <div className="flex flex-col items-center justify-center">
          <Link href={"/admin/foods"}>
            <div className="flex cursor-pointer hover:bg-white group justify-start items-center space-x-4 border-b-2 border-gray-500 w-full p-3">
              <Fastfood className="text-pink-500 ml-2" />
              <h1 className="font-semibold group-hover:text-pink-600">
                Food Items
              </h1>
            </div>
          </Link>
          <Link href={"/admin/users"}>
            <div className="flex cursor-pointer hover:bg-white group justify-start items-center space-x-4 border-b-2 border-gray-500 w-full p-3">
              <Group className="text-pink-500 ml-2" />
              <h1 className="font-semibold group-hover:text-pink-600">
                Users
              </h1>
            </div>
